module.exports = {
    ...
    // ],
    "rules": {
    //   "no-unused-vars": [1, {"args": "none", "varsIgnorePattern": "[cC]onspicuous"}],        // disallow declaration of variables that are not used in the code
...
//
//     "rules": {
//       // To fix react/jsx-quotes being deprecated
//       // "react/jsx-quotes": 0,                          // Enforce quote style for JSX attributes (deprecated)
...
//       // // "arrow-body-style": [1, "always"],              // Arrow functions can omit braces when there is a single statement in the body. This rule enforces the consistent use of braces in arrow functions.
...
//
//
//       // http://blog.javascripting.com/2015/09/07/fine-tuning-airbnbs-eslint-config/
...
//   //   "react/wrap-multilines": 1,                     // Prevent missing parentheses around multilines JSX (fixable)
//
//   //   "react/jsx-quotes": 0,                          // Enforce quote style for JSX attributes (deprecated)
//   //   "jsx-quotes": [2, "prefer-single"],        // Enforce quote style for JSX attributes
//
